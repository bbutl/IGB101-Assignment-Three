...
public class CameraMovement : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        cameraNodes[cameraIndex].transform.position) < proximity)
        {
        ...
        else
        {
            ...
            cameraNodes[cameraIndex].transform.position, moveSpeed * Time.deltaTime);
            //Rotation
            if (objects[cameraIndex])
            {
                targetRotation =
                Quaternion.LookRotation(objects[cameraIndex].transform.position -
                transform.position);
